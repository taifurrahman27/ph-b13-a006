...
const Pricing = () => {
    return (
        <div className='container mx-auto my-5'>
            ...
            <div className='grid justify-center items-center gap-7 md:grid-cols-2 xl:grid-cols-3 h-full'>
                <div className='bg-white card w-96 self-center space-y-3 p-5 h-full'>
                    ...
                    <button className="btn bg-linear-to-r from-[#4F39F6] to-[#9514FA] rounded-full mt-auto">Get Started Free</button>
                </div>


                <div className='bg-linear-to-r from-[#4F39F6] to-[#9514FA] card w-96 self-center space-y-3 p-5 h-full text-white'>
